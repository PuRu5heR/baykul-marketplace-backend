...
import by.baykulbackend.database.dao.order.Status;
...
public class OrderService {
     ...
     */
    @Transactional
    public ResponseEntity<?> updateOrderProductStatus(UUID id, OrderProduct orderProduct) {
        Map<String, String> response = new HashMap<>();
        ...
        if (orderProduct.getNumber() != null) {
            ...
            if (iOrderProductRepository.existsByNumber(orderProduct.getNumber())) {
